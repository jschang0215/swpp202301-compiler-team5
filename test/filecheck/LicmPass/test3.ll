...
; CHECK-NEXT:     %2 = load i32, ptr %x.addr, align 4
; CHECK-NEXT:     %i.promoted = load i32, ptr %i, align 4
; CHECK-NEXT:     %j.promoted3 = load i32, ptr %j, align 4
; CHECK-NEXT:     %s.promoted5 = load i32, ptr %s, align 1
...
; CHECK-NEXT:     store i32 %inc52.lcssa, ptr %i, align 4
; CHECK-NEXT:     store i32 %inc1.lcssa4.lcssa, ptr %j, align 4
; CHECK-NEXT:     store i32 %.lcssa6.lcssa, ptr %s, align 1
; CHECK-NEXT:     ret void
