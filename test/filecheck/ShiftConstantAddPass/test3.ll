...
; CHECK-LABEL: @f(i64 %x, i64 %y)
; CHECK:       entry:
; CHECK-NEXT:     %0 = call i64 @incr_i64(i64 %x)
; CHECK-NEXT:     %1 = call i64 @incr_i64(i64 %0)
; CHECK-NEXT:     %2 = call i64 @decr_i64(i64 %y)
; CHECK-NEXT:     %res1 = mul i64 %1, %2
; CEHCK-NEXT:     ret i64 %res1
entry:
  %incr1 = add i64 %x, 2
  %decr1 = sub i64 %y, 1
  %res1 = mul i64 %incr1, %decr1
  ret i64 %res1
}
...
; CHECK-NEXT:     %res2 = mul i32 %1, %4
; CHECK-NEXT:     ret i32 %res2
entry:
  %incr2 = add i32 %x, 2
  %decr2 = sub i32 %x, 3
  %res2 = mul i32 %incr2, %decr2
  ret i32 %res2
}
...
; CHECK-NEXT:     %res3 = mul i16 %0, %3
; CHECK-NEXT:     ret i16 %res3
entry:
  %incr3 = add i16 %x, 1
  %decr3 = sub i16 %x, 3
  %res3 = mul i16 %incr3, %decr3
  ret i16 %res3
}
...
; CHECK-LABEL: @main()
; CHECK:       entry:
; CHECK-NEXT:     call i64 @f(i64 4, i64 2)
; CHECK-NEXT:     call i32 @g(i32 3)
; CHECK-NEXT:     call i16 @h(i16 2)
; CHECK-NEXT:     call void  @i(i8 1)
; CHECK-NEXT:     call void @k(i1 false)
; CHECK-NEXT:     ret i32 0
entry:
  call i64 @f(i64 4, i64 2)
  call i32 @g(i32 3)
  call i16 @h(i16 2)
  call void @i(i8 1)
