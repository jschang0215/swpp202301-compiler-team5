...
; CHECK:       while.cond:
; CHECK-NEXT:     %1 = load i32, i32* %cmp, align 4
; CHECK-NEXT:     %tobool = icmp ne i32 %1, 0
; CHECK-NEXT:     br i1 %tobool, label %while.end7, label %while.body
while.cond:
...
; CHECK:       while.cond2:
; CHECK-NEXT:     br i1 %tobool, label %while.end, label %while.body4
while.cond2:                       
  br i1 %tobool, label %while.end, label %while.body4
