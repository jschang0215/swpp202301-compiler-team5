...
PreservedAnalyses DeclarePass::run(Module &M, ModuleAnalysisManager &MAM) {
  ...
  // sum
  FunctionType *i1_type = FunctionType::get(Int1, eight_i1, true);
  FunctionType *i8_type = FunctionType::get(Int8, eight_i8, true);
  FunctionType *i16_type = FunctionType::get(Int16, eight_i16, true);
  FunctionType *i32_type = FunctionType::get(Int32, eight_i32, true);
  FunctionType *i64_type = FunctionType::get(Int64, eight_i64, true);
